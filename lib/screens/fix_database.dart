...
void main() async {
  ...
  if (saltati > 0) {
    print('⚠️ Saltati $saltati esercizi (non avevano immagini valide da usare come riferimento).');
  }
  print('Ora cancella il vecchio "esercizi_it.json", rinomina questo nuovo e avvialo!');
}